...
class Returnscom extends React.Component {
    constructor(props) {
        super(props)
            ...
            return (
                <div>
                    <List
                        ...
                        {this.props.name === "returnitems" && products.map(item => (
                            <Collapse in={open} timeout="auto" unmountOnExit>

                                <Orderslistcom name={"returnitems"} item={item} sectionId={this.props.sectionId} callApi={this.callAPI}/>
